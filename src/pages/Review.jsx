...
function Review() {
  ...
  const filteredQuestions = useMemo(() => {
    const ids = activeTab === 'bookmarked' ? bookmarkedQuestions : completedQuestions
  ...
  return (
    <div className="animate-fade-in max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">复习中心</h1>
        <button
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  >
                    {selectedQuestion?.id === question.id ? '收起答案' : '查看答案'}
                  </button>

                  {/* Answer Panel */}
                  {selectedQuestion?.id === question.id && (
                    <div
                      className="mt-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg question-content"
